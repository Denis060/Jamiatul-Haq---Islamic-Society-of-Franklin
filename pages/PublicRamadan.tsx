    ...
    <div className="bg-[#fdfbf7] min-h-screen pb-32">
      <div className="bg-[#042f24] py-32 md:py-48 px-4 text-center relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          ...
          <h1 className="text-5xl md:text-8xl font-black text-white italic mb-8 tracking-tighter leading-none">Ramadan Mubarak</h1>
        ...
        {schedule.length === 0 ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {filteredSchedule.map((day) => (
              <div
                key={day.id}
                className={`bg-white rounded-[3.5rem] border-2 overflow-hidden shadow-sm transition-all group relative animate-in zoom-in-95 duration-500 ${day.is_sponsored ? 'border-[#f0e6d2] grayscale-[0.3]' : 'border-[#d4af37] ring-4 ring-[#d4af37]/5'
                  }`}
              >
