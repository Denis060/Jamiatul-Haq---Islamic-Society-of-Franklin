      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-24">
          ...
          <div className="hidden md:flex items-center space-x-10">
            ...
            <Link 
              to="/admin/login" 
              className="bg-[#d4af37] text-[#042f24] px-6 py-2 rounded-full text-xs font-black uppercase tracking-widest hover:bg-white transition-all shadow-lg"
            >
              Portal
            </Link>
          </div>
        ...
        <div className="md:hidden bg-[#042f24] border-t-2 border-[#d4af37] animate-in slide-in-from-top duration-300">
          <div className="px-4 pt-6 pb-12 space-y-4 text-center">
            ...
            <Link 
              to="/admin/login" 
              onClick={() => setIsOpen(false)}
              className="inline-block mt-8 bg-[#d4af37] text-[#042f24] px-12 py-4 rounded-full font-black uppercase tracking-widest"
            >
              Staff Portal
            </Link>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-16 mb-20">
          <div className="col-span-1 md:col-span-1">
            <h3 className="text-3xl font-black italic mb-6 text-[#d4af37]">Jamiatul Haq</h3>
            <p className="text-sm leading-relaxed text-white/60 mb-8 italic">
              A beacon of faith and service in Franklin Township since 2002. We strive to foster a community rooted in spiritual excellence and compassion.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-6 text-sm">
              <li className="flex items-start gap-3 text-white/70">
                ...
                <span>385 Lewis Street,<br />Somerset, NJ 08873</span>
              </li>
              <li className="flex items-center gap-3 text-white/70">
                <Phone size={20} className="text-[#d4af37] shrink-0" />
                <span>732-322-5221</span>
              </li>
            </ul>
          </div>
